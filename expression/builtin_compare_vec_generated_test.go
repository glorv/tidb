...
func (s *testVectorizeSuite4) TestVectorizedGeneratedBuiltinCompareEvalOneVec(c *C) {
	testVectorizedEvalOneVec(c, vecGeneratedBuiltinCompareCases)
}

func (s *testVectorizeSuite4) TestVectorizedGeneratedBuiltinCompareFunc(c *C) {
